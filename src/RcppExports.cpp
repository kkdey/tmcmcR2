...
RcppExport SEXP tmcmcR2_tmcmcUpdate(SEXP xSEXP, SEXP bSEXP, SEXP epsSEXP, SEXP fSEXP) {
BEGIN_RCPP
...
RcppExport SEXP tmcmcR2_rwmhUpdate(SEXP xSEXP, SEXP epsSEXP, SEXP fSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
